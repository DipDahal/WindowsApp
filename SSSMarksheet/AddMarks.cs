...
namespace SSSMarksheet
{
    public partial class AddMarks : Form
    {
        ...
        {
            /*
            if (comboStream.SelectedItem == "Technical" && comboClass.SelectedItem == "9")
            {
                comboSec.Items.Remove("-");
                comboSec.Items.Remove("A");
                comboSec.Items.Remove("B");
                comboSec.Items.Remove("C");
                if (comboStream.Items == null)
                {
                    comboSec.Items.Add("D");
                }
                comboSec.SelectedItem = "D";
            }
            if (comboStream.SelectedItem == "Technical" && comboClass.SelectedItem == "10")
            {
                comboSec.Items.Remove("-");
                comboSec.Items.Remove("A");
                comboSec.Items.Remove("B");
                comboSec.Items.Remove("D");
                if (comboStream.Items == null)
                {
                    comboSec.Items.Add("C");
                }
                comboSec.SelectedItem = "C";
            }
            if (Convert.ToDouble(comboClass.SelectedItem) >= 1 && Convert.ToDouble(comboClass.SelectedItem) <= 7 )
            {
                comboSec.Items.Remove("D");
                comboSec.Items.Remove("A");
                comboSec.Items.Remove("B");
                ...
                comboSec.SelectedItem = "-";
            }
            if (Convert.ToDouble(comboClass.SelectedItem) >= 11 && Convert.ToDouble(comboClass.SelectedItem) <= 12)
            {
                comboSec.Items.Remove("D");
                comboSec.Items.Remove("A");
                comboSec.Items.Remove("B");
        ...
        public void InsertMarksEntry()
        {
            ...
            {
                MessageBox.Show("Some Error Occur!! Save again");
            }
        }
        ...
        private void dataGridView1_CellValidated(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    if (Convert.ToDouble(dataGridView1.CurrentCell.Value) == Convert.ToDouble(0))
                    {
