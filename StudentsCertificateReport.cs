...
namespace SSSMarksheet
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=SANGATHAN\SQLEXPRESS;Initial Catalog=SSSMarksheets;Integrated Security=True");
        ...
        {
            string conString = @"Data Source=SANGATHAN\SQLEXPRESS;Initial Catalog=SSSMarksheets;Integrated Security=True";
            SqlConnection conn = new SqlConnection(conString);
            DataSet ds = new DataSet();
            try
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("select regid from addStudents", conn);
                SqlDataAdapter da = new SqlDataAdapter();
        ...
        protected void NameFillCombobox()
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("select name from addStudents", conn);
                SqlDataAdapter da = new SqlDataAdapter();
                da.SelectCommand = cmd;
                da.Fill(ds);
        ...
        protected void symbolFillCombobox()
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("select symbolno from addStudents", conn);
                SqlDataAdapter da = new SqlDataAdapter();
                da.SelectCommand = cmd;
                da.Fill(ds);
                comboSymbNo.DisplayMember = "symbolno";
                comboSymbNo.ValueMember = "symbolno";
        ...
        protected void LoadDatagridview()
        {
            ...
            try
            {
                    ...
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("select regid, symbolno, name, stream, classes , sec, rollno, fatherName, motherName, dobBS, municipal, wardNo, district, province, admissionDate, contact from addStudents", conn);
                    SqlDataAdapter da = new SqlDataAdapter();
                    DataTable dt = new DataTable();
                    ...
                    for (int j = 0; j < dt.Rows.Count; j++)
                    {
                        ...
                        dataGridView1.Rows[j].Cells[14].Value = dt.Rows[j].ItemArray[13].ToString();
                        dataGridView1.Rows[j].Cells[15].Value = dt.Rows[j].ItemArray[14].ToString();
                        dataGridView1.Rows[j].Cells[16].Value = dt.Rows[j].ItemArray[15].ToString();
                        conn.Close();
                }
            }
            catch (Exception ee)
        ...
        protected void LoadDatagridviewThroughRegId()
        {
            ...
            try
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("select regid, symbolno, name, stream, classes , sec, rollno, fatherName, motherName, dobBS, municipal, wardNo, district, province, admissionDate, contact from addStudents where regid like '%" + comboRegId.Text + "%' and symbolno like '%" + comboSymbNo.Text + "%'", conn);
                SqlDataAdapter da = new SqlDataAdapter();
                DataTable dt = new DataTable();
        ...
        protected void LoadDatagridviewThroughName()
        {
            ...
            try
            {
                dataGridView1.Rows.Clear();
                conn.Open();
                SqlCommand cmd = new SqlCommand("select regid, symbolno, name, stream, classes , sec, rollno, fatherName, motherName, dobBS, municipal, wardNo, district, province, admissionDate, contact from addStudents where name like '%" + comboName.Text + "%' and classes like '%" + comboClass.Text + "%' and sec like '%" + comboSec.Text + "%' and stream like '%" + comboStream.Text + "%'", conn);
                SqlDataAdapter da = new SqlDataAdapter();
                DataTable dt = new DataTable();
        ...
        protected void LoadDatagridviewThroughrollNo()
        {
            ...
            try
            {
                dataGridView1.Rows.Clear();
                conn.Open();
                SqlCommand cmd = new SqlCommand("select regid, symbolno, name, stream, classes , sec, rollno, fatherName, motherName, dobBS, municipal, wardNo, district, province, admissionDate, contact from addStudents where rollno like '" + comboRollNo.Text + "' and stream like '%" + comboStream.Text + "%' and classes like '%" + comboClass.Text + "%' and sec like '%" + comboSec.Text + "%' ", conn);
                SqlDataAdapter da = new SqlDataAdapter();
                DataTable dt = new DataTable();
        ...
        private void comboRollNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                comboRollNo.BackColor = System.Drawing.Color.Red;
                comboRollNo.ForeColor = System.Drawing.Color.White;
            }
            else
            {
                comboRollNo.BackColor = System.Drawing.Color.White;
                comboRollNo.ForeColor = System.Drawing.Color.Black;
            }
        }
